...
By: Phil Palanza
Date: 9/27/2016
Description: Imports a 5% sample of the behacior data set, merges it with the
			 activity summary data set, and conducts a series of variable
			 creations and transformations. Drops the top 5% of donor observations
			 in FY15 and FY16 (roughly 200k). 
*******************************************************************************/
